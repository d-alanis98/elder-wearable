...
export default class WinstonLogger implements Logger {
    ...
    constructor(context: string) {
        this.logger = winston.createLogger({
            ...
            transports: [
                ...
                new winston.transports.File({ filename: `logs/${ context }/${Levels.DEBUG}.log`, level: Levels.DEBUG }),
                new winston.transports.File({ filename: `logs/${ context }/${Levels.ERROR}.log`, level: Levels.ERROR }),
                new winston.transports.File({ filename: `logs/${ context }/${Levels.INFO}.log`, level: Levels.INFO })
            ]
        });
    }
    ...
    private getMessageToLog = (message: string) => (
